...
class StoreOfficeRouteRequest extends FormRequest
{
    /**
    ...
    {
        // CHANGED: Allow authenticated users to create routes.
        return true;
    }
    ...
    {
        return [
            // CHANGED: Added clearer route-level messages.
            ...
            // CHANGED: Added clearer stop-level messages.
